...
if(isset($_GET['txtID'])){
        ...
        $id_tipo_staff = $registro["id_tipo_staff"];
}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
   ...
   if(empty($errores)){
        ...
        try{
            ...
            $sentencia = $conexion->prepare("UPDATE staff SET nombre=:nombre, apellidos=:apellidos, telefono=:telefono, id_tipo_staff=:id_tipo_staff WHERE id=:id");
...
<div class="row my-2">
    <div class="col-md-4"><br><br></div>
        ...
        <div class="card-body">
            ...
            <form action="editar.php" id="editarStaff" method="post">
                 <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nombre" id="nombre" oninput="validateNombreUsuario()" aria-describedby="helpId" value="<?php echo isset($nombre) ? $nombre : ''; ?>" required/>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="apellidos" id="apellidos" oninput="validateApellidosUsuario()" aria-describedby="helpId" value="<?php echo isset($apellidos) ? $apellidos : ''; ?>" required/>
                    <!--Se llama mensaje de error de validacion de ../../js/validarNombreUsuario.js -->
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="telefono" id="telefono" oninput="validateTelefonoStaff()" aria-describedby="helpId" value="<?php echo isset($telefono) ? $telefono : ''; ?>" required/>
                    ...
                    <select class="form-select form-select-sm" name="id_tipo_staff" id="id_tipo_staff" onclick="validateTipoStaff()"required>
                        <option value="" selected>Seleccione una opción</option>
                            <?php foreach($tipos as $tipo){ ?>
                                    ...
                                    <option <?php echo ($id_tipo_staff == $tipo['id'])?"selected":"";?> value="<?php echo $tipo['id']; ?>"><?php echo $tipo['tipo']; ?></option>
                            <?php }?>
                    </select>
